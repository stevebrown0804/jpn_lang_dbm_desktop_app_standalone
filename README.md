...
*1 Note: You might not want to duplicate the data you store in tags; or, then again, you might want to be "extensive" with the source data.  Your call.  
...
Q) What's up with your tag-naming conventions?  I want capital letters, punctuation and whitespace in my tags!
