...
Q) What does that TSV tell you, you ask?
...
A) Not very, which is why I'm calling it "release 0.0.1+alpha" or some such.  Still, it should (1) run, (2) do what it intends to accomplish (if only barely), and (3) only occasionally crash, which qualifies as "useful enough to justify making the repo public."
